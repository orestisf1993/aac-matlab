function [bands, qsthr, bval] = initBands(frameType)
...
if isESH
    ...
    if nargout > 2
        bval = [0.00, 1.88, 3.70, 5.39, 6.93, 8.29, 9.49, 10.53, 11.45, 12.26, 12.96, 13.59, ...
            14.15, 14.65, 15.11, 15.52, 15.90, 16.56, 17.15, 17.66, 18.13, 18.54, 18.93, 19.28, ...
            19.69, 20.14, 20.54, 20.92, 21.27, 21.64, 22.03, 22.39, 22.76, 23.13, 23.49, 23.85, ...
    ...
    if nargout > 2
        bval = [0.24, 0.71, 1.18, 1.65, 2.12, 2.58, 3.03, 3.48, 3.92, 4.35, 4.77, 5.19, 5.59, ...
            5.99, 6.37, 6.74, 7.10, 7.45, 7.80, 8.20, 8.68, 9.13, 9.55, 9.96, 10.35, 10.71, ...
            11.06, 11.45, 11.86, 12.25, 12.62, 12.96, 13.32, 13.70, 14.05, 14.41, 14.77, 15.13, ...
            15.49, 15.85, 16.20, 16.55, 16.91, 17.25, 17.59, 17.93, 18.28, 18.62, 18.96, 19.30, ...
            19.64, 19.97, 20.31, 20.65, 20.99, 21.33, 21.66, 21.99, 22.32, 22.66, 23.00, 23.33, ...
            23.67, 24.00, 24.00, 24.00, 24.00, 24.00, 24.00];
    end
end
bands = bands + 1;
end
